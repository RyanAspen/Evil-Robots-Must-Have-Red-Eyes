...
public class Soldier extends Globals{
    ...
    public static void paintRuins() throws GameActionException {
        ...
        {
            if ((infos[i].getMark() == PaintType.ALLY_PRIMARY && infos[i].getPaint() != PaintType.ALLY_PRIMARY) || (infos[i].getMark() == PaintType.ALLY_SECONDARY && infos[i].getPaint() != PaintType.ALLY_SECONDARY))
            {
