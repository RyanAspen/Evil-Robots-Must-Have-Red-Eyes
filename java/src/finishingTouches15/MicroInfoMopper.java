...
public class MicroInfoMopper {
    ...
    int safe()
    {
        ...
        if (/*lowHealth &&*/ minDistToTower <= UnitType.LEVEL_ONE_DEFENSE_TOWER.actionRadiusSquared) return minDistToTower-UnitType.LEVEL_ONE_DEFENSE_TOWER.actionRadiusSquared-1;
        return 0;
    }
