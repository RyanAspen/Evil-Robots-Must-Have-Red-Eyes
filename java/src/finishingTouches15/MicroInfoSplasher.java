...
public class MicroInfoSplasher {
    ...
    public MicroInfoSplasher(MapLocation loc, Direction dir, int paintLoss, PaintType type, boolean canMoveM) {
        this.dir = dir;
        this.loc = loc;
    ...
    int safe()
    {
        ...
        if (minDistToTower <= UnitType.LEVEL_ONE_PAINT_TOWER.actionRadiusSquared) return -1;
        return 0;
    }
