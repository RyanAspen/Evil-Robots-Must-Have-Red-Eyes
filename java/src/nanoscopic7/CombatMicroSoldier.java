...
public class CombatMicroSoldier extends Globals{
    public static void soldierAttack() throws GameActionException {
        ...
        if (rc.canAttack(target.getMapLocation()))
        {
            ...
            boolean isRuinOrAllyTower = target.hasRuin() && (targetBot == null || !targetBot.getTeam().isPlayer());
    ...
    public static MapInfo soldierCompare(MapInfo A, MapInfo B) throws GameActionException
    {
        ...
        boolean isRuinOrAllyTowerA = A.hasRuin() && (botA == null || !botA.getTeam().isPlayer());
        boolean isRuinOrAllyTowerB = B.hasRuin() && (botB == null || !botB.getTeam().isPlayer());
        ...
        boolean isEnemyA = botA != null && !botA.getTeam().isPlayer();
        boolean isEnemyB = botB != null && !botB.getTeam().isPlayer();
        ...
        boolean isAllyA = botA != null && botA.getTeam().isPlayer();
        boolean isAllyB = botB != null && botB.getTeam().isPlayer();
