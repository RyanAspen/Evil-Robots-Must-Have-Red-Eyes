...
public class CombatMicroMopper extends Globals
{
    public static void mopperAttack() throws GameActionException {
        ...
        attemptMopSweep(true);
    }

    public static void attemptMopSweep(boolean override) throws GameActionException {
        if (!rc.isActionReady()) return;
        ...
        if (maxNumTargets > 2 || (override && maxNumTargets > 0))
        {
